                ...
                <div className="mb-3">
                  <Form onSubmit={registerUser}>
                    <Form.Group className="mb-3" controlId="Name">
                      <Form.Control type="text" placeholder="Enter Name"  value = {data.name} name='name' onChange={handleChange} />
                    </Form.Group>
                    ...
                    <Form.Group className="mb-3" controlId="formBasicDOB">
                          <Form.Control type="date" placeholder="Date of Birth" value = {data.dob} name='dob' onChange={handleChange}/>
                    </Form.Group>
